...
export default function App() {
  return (
    <BrowserRouter>
      {/* Phase 13 Step 2: session (who's signed in + their profile) is now
          resolved once here, shared by every page/guard below, instead of
          each one independently fetching it on its own mount. Neither this
          nor WorkspaceProvider reads the other's context value, so nesting
          order between them doesn't affect behavior. */}
      <SessionProvider>
        <WorkspaceProvider>
